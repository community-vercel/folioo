...
import { FaFileInvoiceDollar, FaClock, FaShieldAlt, FaMobileAlt, FaCalculator, FaSyncAlt, FaLaptopMedical, FaRocket, FaChartLine } from 'react-icons/fa';
...
export default function MedicalBilling() {
  ...
  const benefits = [
    { 
      ...
      desc: 'Automate claims processing and reduce billing errors by up to 60%.' 
    },
    { 
      icon: FaClock, 
      title: 'Faster Reimbursements', 
      desc: 'Accelerate payment cycles with real-time claim tracking and submission.' 
    },
    { 
      icon: FaShieldAlt, 
      title: 'HIPAA Compliance', 
      desc: 'Secure platforms ensuring patient data privacy and regulatory compliance.' 
    },
    { 
      icon: FaMobileAlt, 
      title: 'Multi-Platform Access', 
      desc: 'Manage billing on iOS, Android, and web with a unified interface.' 
    },
  ];
  ...
  const technologies = [
    ...
    { 
      ...
      title: 'Flutter', 
      desc: 'Builds responsive billing apps with seamless UI and real-time data syncing.',
      features: ['Hot Reload', 'Custom Widgets', 'Native Performance']
    },
    { 
    icon: '/app/1674520932logo.svg',
      title: 'React Native', 
      desc: 'Creates scalable billing solutions with integrations for payment gateways.',
      features: ['Live Reload', 'API Integration', 'Large Community']
    },
    { 
      icon: '/app/5c406461d6b53e4a20b03cba_fhirstarter.svg', 
      title: 'HL7 FHIR', 
      desc: 'Enables interoperable data exchange for billing and patient records.',
      features: ['API Standards', 'Interoperability', 'Scalability']
    },
  ];
  ...
  const showcaseProjects = [
    { 
      title: 'ClaimSync Pro', 
      desc: 'Flutter-based medical billing app with automated claims submission and real-time status tracking.', 
      image: '/app/form.png', 
      tags: ['Flutter', 'Firebase', 'Stripe']
    },
    { 
      title: 'BillCare Mobile', 
      desc: 'React Native app for managing patient invoices with EHR and payment gateway integration.', 
      image: '/app/whyus.png', 
      tags: ['React Native', 'GraphQL', 'EHR']
    },
    { 
      title: 'MediBill Connect', 
      desc: 'FHIR-based platform for seamless billing data sharing across healthcare systems.', 
      image: '/app/document.png', 
      tags: ['HL7 FHIR', 'Azure', 'REST APIs']
    },
  ];

  const processSteps = [
    { icon: FaCalculator, title: 'Billing UX Design', desc: 'Intuitive interfaces tailored to medical billing workflows.' },
    { icon: FaLaptopMedical, title: 'Development', desc: 'Secure, scalable solutions with billing-specific integrations.' },
    { icon: FaSyncAlt, title: 'Testing & Compliance', desc: 'Rigorous testing for accuracy, security, and HIPAA compliance.' },
    { icon: FaRocket, title: 'Deployment', desc: 'Launch on app stores and web with ongoing support.' },
  ];

  // Split headline for animation
  const headline = "Medical Billing Solutions".split('');
  ...
  return (
    <>
      ...
      <div className="relative bg-gradient-to-b from-[#2e6b6e] to-gray-800 min-h-screen overflow-hidden">
        ...
        <section ref={heroRef} className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 py-24 sm:py-36">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              >
                We develop secure, efficient medical billing solutions to streamline claims, reduce errors, and accelerate reimbursements.
              </motion.p>
            ...
            >
              <div className="relative perspective-1000 group">
                ...
                <div className="relative bg-gray-800/50 backdrop-blur-md rounded-2xl overflow-hidden border border-gray-700/50 transform group-hover:-translate-y-2 transition-transform duration-500">
                  <Image
                    src="/app/image-84.png"
                    alt="Medical Billing App Mockup"
                    width={600}
                    height={500}
                    sizes="(max-width: 768px) 100vw, 50vw"
                    className="w-full object-contain"
                    priority
                    onError={(e) => (e.currentTarget.src = '/billing/fallback-mockup.webp')}
                  />
                </div>
              </div>
            </motion.div>
        ...
        <section ref={benefitsRef} className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 mt-12 sm:mt-12">
          ...
          <div className="mt-20 bg-gradient-to-r from-gray-900/50 via-gray-800/50 to-gray-900/50 backdrop-blur-md rounded-2xl p-8 sm:p-12 border border-gray-700/50">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h3 className="text-2xl font-bold text-white mb-4">Billing Efficiency</h3>
                <p className="text-gray-300 mb-6">
                  Our solutions reduce administrative overhead and improve revenue cycle management.
                </p>
        ...
        <section ref={technologiesRef} className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 mt-24 sm:mt-32">
          <motion.div
            initial="hidden"
                ...
                <div className="p-8">
                  <div className="w-16 h-16 mb-6 bg-gradient-to-br from-green-500/10 to-cyan-500/10 rounded-lg flex items-center justify-center">
                    <Image
                      ...
                      onError={(e) => (e.currentTarget.src = '/billing/fallback-tech-icon.webp')}
                    />
                  </div>
            ...
            {showcaseProjects.map((project, idx) => (
              ...
              >
                ...
                <Image
                  ...
                  loading="lazy"
                  onError={(e) => (e.currentTarget.src = '/billing/fallback-project-image.webp')}
                />
        ...
        <section ref={ctaRef} className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16 mt-24 sm:mt-32 pb-24">
          ...
          >
            <div className="absolute inset-0 bg-[url('/billing/grid-pattern-billing.webp')] bg-[length:40px_40px] opacity-5"></div>
            ...
            <div className="relative z-10 p-12 sm:p-16 lg:p-20 text-center">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-10">
                Let’s create a secure, efficient billing system to optimize your revenue cycle management.
              </p>
        ...
        >
          <Link
            ...
            aria-label="Chat with us about medical billing solutions"
          >
