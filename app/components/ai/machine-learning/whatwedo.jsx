    ...
    <main className="font-sans">
          ...
          {[
            {
              ...
              icon: <FiCode className="text-white" size={32} />,
            },
            {
              ...
              icon: <FaBrain className="text-white" size={32} />,
            },
            {
              ...
              icon: <FiTool className="text-white" size={32} />,
            },
            {
              ...
              icon: <BsRocket className="text-white" size={32} />,
            },
          ].map((item, index) => (
            <div
              key={index}
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 bg-[#446f70] rounded-full mb-4 mx-auto">
                {item.icon}
              </div>
     ...
     {[
      ...
      <section className="py-20 bg-gradient-to-b from-[#0b1736] to-[#1a3558] text-white text-center">
        <h2 className="text-3xl font-extrabold bg-clip-text text-gray   mb-10 animate-fade-in">
