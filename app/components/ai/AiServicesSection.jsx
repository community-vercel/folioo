...
const services = [
  {
    icon: <FiSettings size={32} className="text-cyan-500 mb-4" />,
  ...
  {
    icon: <FiEye size={32} className="text-cyan-500 mb-4" />,
  ...
  {
    icon: <MdAutoAwesome size={32} className="text-cyan-500 mb-4" />,
  ...
  {
    icon: <FiCpu size={32} className="text-cyan-500 mb-4" />,
  ...
  {
    icon: <FiUserCheck size={32} className="text-cyan-500 mb-4" />,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              <button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold px-5 py-2 rounded-full hover:bg-blue-700 hover:scale-105 transition-all duration-300">
                {service.btn}
              </button>
            </div>
          ))}
