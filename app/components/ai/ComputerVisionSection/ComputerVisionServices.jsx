...
const services = [
  {
    ...
    icon: <FiTarget className="text-white" size={40} />,
  },
  {
    ...
    icon: <FiSmartphone className="text-white" size={40} />,
  },
  {
  ...
  },
  {
    ...
    icon: <FiSearch className="text-white" size={40} />,
  },
];
  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800 bg-clip-text  ">
        ...
        <div className="mt-6">
          ...
          <div className="mt-12">
            ...
            <button
              className="bg-[#446f70] text-white font-semibold px-8 py-3 rounded-full hover:bg-[#446f70] hover:text-white transition-all duration-300"
